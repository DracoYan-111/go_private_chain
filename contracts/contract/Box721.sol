...
contract CreateBox721 {
    ...
    */
    ...
    function callBox721(address box721Address, bytes memory data) external returns (bytes memory) {
...
contract ContractCall {
    function pauseCall() external pure returns (bytes memory data){
        data = abi.encodeWithSelector(Box721.pause.selector);
    }

    function unpauseCall() external pure returns (bytes memory data){
        data = abi.encodeWithSelector(Box721.unpause.selector);
    }

    function setMinterCall(address minterAddress) external pure returns (bytes memory data){
    ...
    function batchSafeBurnCall(uint256[] memory tokenIds) external pure returns (bytes memory data){
